...
<body>
        ...
        <span>
          ...
          <form action="name.php" method="post">
            ...
            <form action="display.php" method="post">
              ...
              <input class="www" type="submit" name="suname" value="Check Donations">
            </form>
  ...
  <div class="form11">
    <form action="RaiseCharityRedirect.php" enctype="multipart/form-data" name="f1" id="f1" method="POST"
      ...
      <fieldset>
        ...
        <label class="s11" id="1" for="">Name of the Charity</label>
        <input class="t12" type="text" id="Cname" name="Cname" placeholder="Enter Name of the Charity...">
        <br /><br />
        <label class="s11" id="2" for="">Purpose</label>
        <input class="t12" type="textarea" id="purp" name="purp" placeholder="Enter Purpose">
        <br><br />

        <label class="s11" id="3" for="">Founder</label>
        <input class="t12" type="text" placeholder="Enter Your Name..." id="Founder" name="Founder">
        <br><br />
        <label class="s11" id="4">Charity Cover Image</label>&nbsp;&nbsp;&nbsp;
        <input type="file" id="cimg" name="image" value="" required><br>
